...
namespace Ref {
  ...
  DpDemo_StructWithEverything ::
    DpDemo_StructWithEverything() :
      ...
      m_F32Array(Ref::DpDemo_F32Array(0.0f)),
      m_U32Array(Ref::DpDemo_U32Array(0)),
      m_enumArray(Ref::DpDemo_EnumArray(Ref::DpDemo_ColorEnum::RED)),
      m_stringArray(Ref::DpDemo_StringArray(Fw::String(""))),
      m_booleanArray(Ref::DpDemo_BooleanArray(false)),
      m_structWithStrings(Fw::String(""), Ref::DpDemo_StringArray(Fw::String(""))),
      m_nestedArrays(Ref::DpDemo_ArrayOfStringArray(Ref::DpDemo_StringArray(Fw::String(""))))
  {
    for (FwSizeType i = 0; i < 2; i++) {
      this->m_arrayMemberU32[i] = Ref::DpDemo_U32Array(0);
    }
  }
